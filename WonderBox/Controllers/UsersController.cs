...
namespace WonderBox.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult AdminView()
        {
            ...
            //UserInfo.TotalMonthlySubcription = db.Users.Count();
            ...
            //var MaleInfo = db.Users.Where(m => m.Gender == Male).Count();
            //var FemaleInfo = db.Users.Where(f => f.Gender == Female).Count();


            //UserInfo.TotalMale = MaleInfo;
            //UserInfo.TotalFemale = FemaleInfo;
        ...
        public ActionResult BuyMonthly()
        {
            ...
            UserInfo.MonthlySubscription++;
            UserInfo.TotalMonthlyRevenuIncoming += SubscriptionName.MonthlyPrice;
        ...
        public ActionResult BuyYearly()
        {
            ...
            UserInfo.YearlySubscription++;
            UserInfo.TotalMonthlyRevenuIncoming += SubscriptionName.YearlyPrice / 12;
