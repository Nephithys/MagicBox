...
namespace WonderBox.Controllers
{
    public class SurveysController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Quetion1,Quetion2,Quetion3,Quetion4,Quetion5,Quetion6")] Survey survey)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Quetion1,Quetion2,Quetion3,Quetion4,Quetion5,Quetion6")] Survey survey)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            Survey survey = db.Surveys.Find(id);
            this.Answer1 = Int32.Parse(survey.Quetion1);
            this.Answer2 = Int32.Parse(survey.Quetion2);
            this.Answer3 = Int32.Parse(survey.Quetion3);
            this.Answer4 = Int32.Parse(survey.Quetion4);
            this.Answer5 = Int32.Parse(survey.Quetion5);
            this.Answer6 = Int32.Parse(survey.Quetion6);
